...
export type MedicalEquipmentFormData = z.infer<typeof medicalEquipmentSchema>;

export interface MedicalEquipmentItem extends BaseAssetItem {
  article: string;
  description: string;
  property_no: string;
  unit_measure: string;
...
function mapMedicalEquipmentRow(
...
export const medicalEquipmentModule = createPpeModule<
  MedicalEquipmentItem,
  MedicalEquipmentFormData
>({
  moduleKey: "medical_equipment",
  table: "medical_equipment",
  route: "/ppe/medical-equipment",
  publicSlug: "medical-equipment",
  labels: {
    singular: "medical equipment",
    plural: "schedule of medical equipment",
    summaryTitle: "medical equipment",
    addButton: "add data",
    addModal: "add data",
    editModal: "edit data",
    description: "report on the physical count of inventories",
    publicTitle: "medical equipment information",
  },
