...
export type AFEFormData = z.infer<typeof aFESchema>;

export interface AFEItem extends BaseAssetItem {
  article: string;
  description: string;
  stock_no: string;
  unit_measure: string;
...
function mapAFERow(row: Record<string, unknown>): AFEItem {
...
export const aFEModule = createPpeModule<AFEItem, AFEFormData>({
  moduleKey: "agricultural_and_forestry_equipment",
  table: "agricultural_and_forestry_equipment",
  route: "/ppe/agricultural-and-forestry-equipment",
  publicSlug: "agricultural-and-forestry-equipment",
  labels: {
    singular: "agricultural and forestry equipment",
    plural: "schedule of agricultural and forestry equipment",
    summaryTitle: "agricultural and forestry equipment",
    addButton: "add data",
    addModal: "add data",
    editModal: "edit data",
    description: "report on the physical count of inventories",
    publicTitle: "agricultural and forestry equipment information",
  },
