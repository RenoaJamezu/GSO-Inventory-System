...
export type DREFormData = z.infer<typeof dRESchema>;

export interface DREItem extends BaseAssetItem {
  article: string;
  description: string;
  stock_no: string;
  unit_measure: string;
...
function mapDRERow(row: Record<string, unknown>): DREItem {
...
export const dREModule = createPpeModule<DREItem, DREFormData>({
  moduleKey: "disaster_and_rescue_equipment",
  table: "disaster_and_rescue_equipment",
  route: "/ppe/disaster-and-rescue-equipment",
  publicSlug: "disaster-and-rescue-equipment",
  labels: {
    singular: "disaster and rescue equipment",
    plural: "disaster and rescue equipment",
    summaryTitle: "disaster and rescue equipment",
    addButton: "add data",
    addModal: "add data",
    editModal: "edit data",
    description: "report on the physical count of inventories",
    publicTitle: "disaster and rescue equipment information",
  },
