...
export const oMESchema = z.object({
...
export type OMEFormData = z.infer<typeof oMESchema>;

export interface OMEItem extends BaseAssetItem {
  article: string;
  description: string;
  property_no: string;
  unit_measure: string;
...
export const oMEModule = createPpeModule<
  OMEItem,
  OMEFormData
>({
  moduleKey: "other_machineries_and_equipment",
  table: "other_machineries_and_equipment",
  route: "/ppe/other-machineries-and-equipment",
  publicSlug: "other-machineries-and-equipment",
  labels: {
    singular: "other machineries and equipment",
    plural: "schedule of other machineries and equipment",
    summaryTitle: "other machineries and equipment",
    addButton: "add data",
    addModal: "add data",
    editModal: "edit data",
    description: "report on the physical count of inventories",
    publicTitle: "other machineries and equipment information",
  },
