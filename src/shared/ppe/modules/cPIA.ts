...
export type CPIAFormData = z.infer<typeof cPIASchema>;

export interface CPIAItem extends BaseAssetItem {
  structure_id: string;
  location: string;
  building_no: string;
  property_no: string;
...
function mapCPIARow(row: Record<string, unknown>): CPIAItem {
...
export const cPIAModule = createPpeModule<CPIAItem, CPIAFormData>({
  moduleKey: "construction_in_progress_infrastructure_asset",
  table: "construction_in_progress_infrastructure_asset",
  route: "/ppe/construction-in-progress-infrastructure-asset",
  publicSlug: "construction-in-progress-infrastructure-asset",
  labels: {
    singular: "construction in progress-infrastucture asset",
    plural: "schedule of construction in progress-infrastucture assets",
    summaryTitle: "construction in progress-infrastucture asset",
    addButton: "add data",
    addModal: "add data",
    editModal: "edit data",
    description: "report on the physical count of construction in progress-infrastucture assets",
    publicTitle: "construction in progress-infrastucture asset information",
  },
