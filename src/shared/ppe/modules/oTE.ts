...
export const oTESchema = z.object({
...
export type OTEFormData = z.infer<typeof oTESchema>;

export interface OTEItem extends BaseAssetItem {
  article: string;
  description: string;
  property_no: string;
  unit_measure: string;
...
export const oTEModule = createPpeModule<
  OTEItem,
  OTEFormData
>({
  moduleKey: "other_transportation_equipment",
  table: "other_transportation_equipment",
  route: "/ppe/other-transportation-equipment",
  publicSlug: "other-transportation-equipment",
  labels: {
    singular: "other transportation equipment",
    plural: "schedule of other transportation equipment",
    summaryTitle: "other transportation equipment",
    addButton: "add data",
    addModal: "add data",
    editModal: "edit data",
    description: "report on the physical count of inventories",
    publicTitle: "other transportation equipment information",
  },
