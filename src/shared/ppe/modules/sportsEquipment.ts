...
export const sportsEquipmentSchema = z.object({
...
export type SportsEquipmentFormData = z.infer<typeof sportsEquipmentSchema>;

export interface SportsEquipmentItem extends BaseAssetItem {
  article: string;
  description: string;
  property_no: string;
  unit_measure: string;
...
function mapSportsEquipmentRow(
...
export const sportsEquipmentModule = createPpeModule<
  SportsEquipmentItem,
  SportsEquipmentFormData
>({
  moduleKey: "sports_equipment",
  table: "sports_equipment",
  route: "/ppe/sports-equipment",
  publicSlug: "sports-equipment",
  labels: {
    singular: "sports equipment",
    plural: "schedule of sports equipment",
    summaryTitle: "sports equipment",
    addButton: "add data",
    addModal: "add data",
    editModal: "edit data",
    description: "report on the physical count of inventories",
    publicTitle: "sports equipment information",
  },
  ...
  tableColumns: [
    ...
    { header: "property no", key: "property_no" },
