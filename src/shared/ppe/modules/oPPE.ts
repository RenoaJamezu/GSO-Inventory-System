...
export const oPPESchema = z.object({
...
export type OPPEFormData = z.infer<typeof oPPESchema>;

export interface OPPEItem extends BaseAssetItem {
  article: string;
  description: string;
  property_no: string;
  unit_measure: string;
...
export const oPPEModule = createPpeModule<
  OPPEItem,
  OPPEFormData
>({
  moduleKey: "other_property_plant_and_equipment",
  table: "other_property_plant_and_equipment",
  route: "/ppe/other-property-plant-and-equipment",
  publicSlug: "other-property-plant-and-equipment",
  labels: {
    singular: "other property plant and equipment",
    plural: "schedule of other property plant and equipment",
    summaryTitle: "other property plant and equipment",
    addButton: "add data",
    addModal: "add data",
    editModal: "edit data",
    description: "report on the physical count of inventories",
    publicTitle: "other property plant and equipment information",
  },
