...
export type MotorVehicleFormData = z.infer<typeof motorVehicleSchema>;

export interface MotorVehicleItem extends BaseAssetItem {
  article: string;
  description: string;
  property_no: string;
  unit_measure: string;
...
export const motorVehicleModule = createPpeModule<
  MotorVehicleItem,
  MotorVehicleFormData
>({
  moduleKey: "motor_vehicle",
  table: "motor_vehicle",
  route: "/ppe/motor-vehicle",
  publicSlug: "motor-vehicle",
  labels: {
    singular: "motor vehicle",
    plural: "schedule of motor vehicle",
    summaryTitle: "motor vehicle",
    addButton: "add data",
    addModal: "add data",
    editModal: "edit data",
    description: "report on the physical count of inventories",
    publicTitle: "motor vehicle information",
  },
