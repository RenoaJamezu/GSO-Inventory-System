...
export const communicationEquipmentSchema = z.object({
  id: z.number().nullable().optional(),
  article: z.string().nullable().optional(),
  description: z.string().nullable().optional(),
  stock_no: z.string().nullable().optional(),
...
export type CommunicationEquipmentFormData = z.infer<typeof communicationEquipmentSchema>;

export interface CommunicationEquipmentItem extends BaseAssetItem {
  article: string;
  description: string;
  stock_no: string;
  unit_measure: string;
...
function mapCommunicationEquipmentRow(row: Record<string, unknown>): CommunicationEquipmentItem {
...
export const communicationEquipmentModule = createPpeModule<CommunicationEquipmentItem, CommunicationEquipmentFormData>({
  moduleKey: "communication_equipment",
  table: "communication_equipment",
  route: "/ppe/communication-equipment",
  publicSlug: "communication-equipment",
  labels: {
    singular: "communication equipment",
    plural: "schedule of communication equipment",
    summaryTitle: "communication equipment",
    addButton: "add data",
    addModal: "add data",
    editModal: "edit data",
    description: "report on the physical count of inventories",
    publicTitle: "communication equipment information",
  },
  ...
  fields: [
    ...
    { label: "stock number", name: "stock_no" },
  ...
  schema: communicationEquipmentSchema,
  emptyForm: {
    group_id: null,
    article: "",
    description: "",
  ...
  tableColumns: [
    ...
    { header: "stock number", key: "stock_no" },
  ...
  publicFields: [
    ...
    { label: "stock number", key: "stock_no" },
  ...
  mapRow: mapCommunicationEquipmentRow,
});
