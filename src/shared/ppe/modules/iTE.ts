...
export const iTESchema = z.object({
...
export type ITEFormData = z.infer<typeof iTESchema>;

export interface ITEItem extends BaseAssetItem {
  article: string;
  description: string;
  stock_no: string;
  unit_measure: string;
...
function mapITERow(row: Record<string, unknown>): ITEItem {
...
export const iTEModule = createPpeModule<ITEItem, ITEFormData>({
  moduleKey: "information_technology_equipment",
  table: "information_technology_equipment",
  route: "/ppe/information-technology-equipment",
  publicSlug: "information-technology-equipment",
  labels: {
    singular: "information technology equipment",
    plural: "schedule of information technology equipment",
    summaryTitle: "information technology equipment",
    addButton: "add data",
    addModal: "add data",
    editModal: "edit data",
    description:
      "report on the physical count of property, plant and equipment",
    publicTitle: "information technology equipment information",
  },
