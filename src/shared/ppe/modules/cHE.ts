...
export const cHESchema = z.object({
...
export type CHEFormData = z.infer<typeof cHESchema>;

export interface CHEItem extends BaseAssetItem {
  article: string;
  description: string;
  stock_no: string;
  unit_measure: string;
...
function mapCHERow(row: Record<string, unknown>): CHEItem {
...
export const cHEModule = createPpeModule<CHEItem, CHEFormData>({
  moduleKey: "construction_and_heavy_equipment",
  table: "construction_and_heavy_equipment",
  route: "/ppe/construction-and-heavy-equipment",
  publicSlug: "construction-and-heavy-equipment",
  labels: {
    singular: "construction and heavy equipment",
    plural: "schedule of construction and heavy equipment",
    summaryTitle: "construction and heavy equipment",
    addButton: "add data",
    addModal: "add data",
    editModal: "edit data",
    description: "report on the physical count of inventories",
    publicTitle: "construction and heavy equipment information",
  },
