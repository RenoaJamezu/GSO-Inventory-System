...
export const otherLandModule = createPpeModule<OtherLandItem, OtherLandFormData>({
  ...
  labels: {
    ...
    plural: "other land improvement Records",
    summaryTitle: "other land improvements",
    addButton: "add other land improvement",
    addModal: "add other land improvement",
    editModal: "edit other land improvement",
    description: "report on the physical count of other land improvement", 
